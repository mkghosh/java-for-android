...
public class Logic 
    ...
    public static double boxSurfaceArea(double length, double width,
                                        double depth) {
        //determining the lateral surface area of the box.
        double lateralSurfaceArea = 2 * depth * (length + width);

        //determining the base surface area of the box.
        double baseSurfaceArea = 2 * length * width;

        //The total surface area is the sum total of the lateral and base surface area
